...
<div class='size-full relative'>
  <div class='[container-type:size] aspect-[4/3] inset-0 absolute m-auto max-w-full max-h-full'>
    <svg class='' xmlns='http://www.w3.org/2000/svg' version='1.0' viewBox='0 0 672 504'>
